from indic_numtowords.ben.data.nums import exceptions_dict
from indic_numtowords.ben.data.nums import direct_dict
from indic_numtowords.ben.data.nums import higher_dict
from indic_numtowords.ben.data.nums import hundreds_dict

from indic_numtowords.ben.utils import combine
