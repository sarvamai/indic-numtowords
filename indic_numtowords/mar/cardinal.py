from indic_numtowords.mar.data.nums import exceptions_dict
from indic_numtowords.mar.data.nums import direct_dict
from indic_numtowords.mar.data.nums import higher_dict
from indic_numtowords.mar.data.nums import variations_dict

from indic_numtowords.mar.utils import combine
